...
TRANSLATIONS = {
    'de': {
        ...
        'config_comparison_hint': 'Geänderte Werte: Vorher → Nachher. Unveränderte Werte werden einmal angezeigt.',
    ...
    'en': {
        ...
        'config_comparison_hint': 'Changed values: Before → After. Unchanged values are shown once.',
